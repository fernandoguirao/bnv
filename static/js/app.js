        ...
        if (entry["clase"] === clase) {
          ...
          $.each(this.entrada, function(entryIndex, entry) {
            if (entry.posicion === "centro") {
              ...
              return $(".procentra").append("<div class=\"columna50 izqu\"><h1>" + entry.titulo + "</h1><p>" + entry.texto + "</p></div><div class=\"columna50\"><img src=\"" + entry.imagen + "\" alt=\"\"></div>");
            } else if (entry.posicion === "sesentaycinco") {
              console.log("3/ posicion 65");
              return $(".procentra").append("<div class=\"columna65 izqu\"><img src=\"" + entry.imagen + "\" alt=\"\"></div><div class=\"columna35\"><h5>" + entry.subtitulo + "</h5><p>" + entry.texto + "</p></div>");
            } else if (entry.posicion === "imagenes") {
              console.log("3/ posicion imagen");
              return $(".procentra").append("<img src=\"" + entry.imagen + "\" alt=\"\">");
            } else if (entry.posicion === "imagenes50") {
              console.log("3/ imagenes 50");
              return $(".procentra").append("<h1>" + entry.titulo + "</h1><div class=\"linea\"></div><h5>" + entry.subtitulo + "</h5><div class=\"columna50 izqu\"><img src=\"" + entry.imagen1 + "\" alt=\"\"></div><div class=\"imagenex columna50\"><img src=\"" + entry.imagen2 + "\" alt=\"\"></div>");
            }
          });
